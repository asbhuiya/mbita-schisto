...
#-----------------------------------
foi_ests <- read_rds(path = here("output","mbita-village-foi.rds")) %>%
...
ggsave(filename=here("output","mbita-village-sea-kk-comparison.png"),plot=comp_fig,device="png",width=8,height=8)
```
